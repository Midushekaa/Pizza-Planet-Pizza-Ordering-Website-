...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span> Pizza Planet</span></a>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>"Made with Love" pizza is all about the extra care and attention to detail that goes into creating a delicious and memorable meal.</p>
      ...
      <div class="box">
         ...
         <p>Many pizza places aim to deliver within 30 minutes as a part of their service promise. This quick delivery window ensures your pizza arrives hot and fresh.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
      ...
      <div class="box">
         ...
         <p>There's nothing quite like sharing a pizza with friends! Here are some tips to make your pizza night a memorable one Sharing pizza with friends is always a great idea!</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
   ...
   <div class="accordion-container">
      ...
      <div class="accordion active">
         ...
         <p class="accrodion-content">
            Creating a delicious pizza involves a few key steps that bring together a mix of flavors and textures.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            The delivery time for pizza can vary based on several factors, such as the distance from the restaurant to your location, the restaurant's current order volume, and traffic conditions.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            Absolutely! Most pizza restaurants are equipped to handle large orders for parties and events.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            The protein content in pizza can vary widely based on the type of crust, the amount of cheese, and the toppings used.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            Yes, oil is often used in the preparation and cooking of pizza.
         </p>
      </div>
